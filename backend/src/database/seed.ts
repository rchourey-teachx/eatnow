  ...
  try {
    ...
    await postgresClient.query(`
      INSERT INTO riders (id, name, phone, email, vehicle_type, status) VALUES
        ('rrrr1111-1111-1111-1111-111111111111', 'Mike Rider', '+5551111111', 'mike@riders.com', 'motorcycle', 'offline'),
        ('rrrr2222-2222-2222-2222-222222222222', 'Sarah Driver', '+5552222222', 'sarah@riders.com', 'bicycle', 'offline'),
        ('rrrr3333-3333-3333-3333-333333333333', 'Tom Courier', '+5553333333', 'tom@riders.com', 'car', 'offline')
      ON CONFLICT (id) DO NOTHING;
    `);
